...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">
        <a href="{{route('admin.contacts.index')}}" class="text-muted">{{__('aside.contact')}}</a>
    </li>
@stop
    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            <div class="card-title">
                <h3 class="card-label">{{__('contact.title')}}
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-4 my-2 my-md-0">
                                <div class="input-icon">
                                    <input type="text" class="form-control" placeholder="{{__('general.search_username')}}" name="s_name" id="s_name" />
                                    <span>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.delete').click(function (e) {
                ...
                var url = '{{route('admin.contacts.destroy')}}';
                var type = "post";
                $.ajax({
                    type: type,
                    url: url,
