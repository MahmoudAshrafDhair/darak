...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">
        <a href="{{route('admin.pages.terms_and_conditions')}}" class="text-muted">{{__('page.terms_and_conditions')}}</a>
    </li>
        ...
        <div class="col-lg-12">
            ...
            <div class="card card-custom ">
                <div class="card-header">
                    <h3 class="card-title">{{__('page.terms_and_conditions')}}</h3>
                </div>
                <!--begin::Form-->
                <form class="form" method="post" action="{{route('admin.pages.terms_and_conditions_update')}}"
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <div class="col-lg-12">
                                <label>{{__('page.terms_and_conditions_ar')}}</label>
                        ...
                        <div class="form-group row">
                            <div class="col-lg-12">
                                <label>{{__('page.terms_and_conditions_en')}}</label>
