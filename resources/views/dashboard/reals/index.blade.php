...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">
        <a href="{{route('admin.reals.index')}}" class="text-muted">{{__('aside.real')}}</a>
    </li>
@stop
    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            <div class="card-title">
                <h3 class="card-label">{{__('real.title')}}
                {{--                    <span class="text-muted pt-2 font-size-sm d-block">Javascript array as data source</span></h3>--}}
            </div>
            <div class="card-toolbar">
                <!--begin::Button-->
{{--                <a href="{{route('admin.reals.create')}}" class="btn btn-info font-weight-bolder">--}}
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-4 my-2 my-md-0">
                                <div class="d-flex align-items-center">
                                    <label class="mr-3 mb-0 d-none d-md-block">{{__('real.type')}}</label>
                                    <select class="form-control" id="type">
                                        <option value="-1">{{__('real.all')}}</option>
                                        <option value="0">{{__('real.sale')}}</option>
                                        <option value="1">{{__('real.rent')}}</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-4 my-2 my-md-0">
                                <div class="d-flex align-items-center">
                                    <label class="mr-3 mb-0 d-none d-md-block">{{__('real.category')}}</label>
                                    <select class="form-control" id="category">
                                        <option value="0">{{__('real.all')}}</option>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.delete').click(function (e) {
                ...
                var url = '{{route('admin.reals.destroy')}}';
                var type = "post";
                $.ajax({
                    type: type,
                    url: url,
