...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">
        <a href="{{route('admin.sliders.edit',$slider->id)}}" class="text-muted">{{__('slider.edit')}}</a>
    </li>
@stop
        ...
        <div class="col-lg-12">
            ...
            <div class="card card-custom">
                <div class="card-header">
                    <h3 class="card-title">{{__('slider.edit')}}</h3>
                </div>
                <!--begin::Form-->
                <form class="form" method="post" action="{{route('admin.sliders.update',$slider->id)}}" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <img id="blah" class="media-object img-thumbnail" width="150" height="150"
                                                                                  src="{{$slider->image == null ? asset('assets/image/defoult.png') : asset('storage/'.$slider->image)}}"
                            ...
                            <div class="col-lg-6">
                                ...
                                <select class="form-control" id="kt_select2_1" name="real_estate_id">
                                    ...
                                    @foreach($reals as $real)
                                        <option value="{{$real->id}}" @if($real->real_estate_id === $slider->id) selected @endif>{{$real->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
